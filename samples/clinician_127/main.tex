...
{\doublespacing
This is to certify that {\large\sffamily\bfseries\color{name}{\dg.~\name}}, {\dgn} at {\sub}, {\inst}, {\place}, has participated in the 7th and 11th sessions (between June 2019 and May 2022) of the User Test and Analysis phases for the ``\emph{\color{project}{MIMBCD-UI}}'' project organized  by  Department of Computer Science and Engineering, Instituto Superior T\'{e}cnico,  Universidade de Lisboa, Portugal.}
