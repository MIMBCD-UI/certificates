...
{\doublespacing
This is to certify that {\large\sffamily\bfseries\color{name}{\dg.~Pedro Tom\'{a}s Marques}}, {\dgn} at {\sub}, {\inst}, {\place}, has participated in the 4th, 7th, 8th, 9th, 10th and 11th User Test and Analysis studies on ``\emph{\color{project}{MIMBCD-UI Project}}'' organized  by  Department of Computer Science and Engineering, Instituto Superior T\'{e}cnico,  Universidade de Lisboa, Portugal.}
