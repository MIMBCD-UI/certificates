...
{\doublespacing
This is to certify that {\sffamily\bfseries\color{name}{\dg.~\name}}, {\dgn} at {\sub}, {\inst}, {\place}, has participated in the User Testing and Analysis (UTA) phases, referenced as UTA15 session (September 2024 to September 2025), under the ``MIMBCD-UI'' initiative organized  by  Department of Computer Science and Engineering, Instituto Superior T\'{e}cnico,  University of Lisbon, Portugal.}
...
{Francisco Maria Calisto\\francisco.calisto@tecnico.ulisboa.pt}
\end{minipage}
\hfill
}
%=============================
