...
{\doublespacing
This is to certify that {\sffamily\bfseries\color{name}{\dg.~\name}}, {\dgn} at {\sub}, {\inst}, {\place}, has participated in the User Testing and Analysis (UTA) phases, referenced as UTA13 session (September 2023 to September 2024), under the ``MIMBCD-UI'' initiative organized  by  Department of Computer Science and Engineering, Instituto Superior T\'{e}cnico,  University of Lisbon, Portugal.}
