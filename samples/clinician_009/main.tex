...
{\onehalfspacing
    ...
    {\Large\bfseries\color{project}{MIDA}}}\\
    \par}
\end{minipage}
\hfill
%=============================
...
{\doublespacing
This is to certify that {\large\sffamily\bfseries\color{name}{\dg.~\name}}, {\dgn} at {\sub}, {\inst}, {\place}, has participated in the 7th User Test and Analysis on ``\emph{\color{project}{Medical Imaging Diagnosis Assistant (MIDA) Project}}'' organized  by  Department of Computer Science and Engineering, Instituto Superior T\'{e}cnico,  Universidade de Lisboa, Portugal.}
...
{Francisco Maria Calisto\\Research Assistant \& PhD Student\\francisco.calisto@tecnico.ulisboa.pt}
\end{minipage}
\hfill
}
%=============================
