...
{\doublespacing
This is to certify that {\large\sffamily\bfseries\color{name}{\dg.~\name}}, {\dgn} of {\sub}, {\inst}, {\place}, has participated in the User Analyzis on ``\emph{\color{project}{MIMBCD-UI Project}}''   organized  by  Department of Computer Science and Engineering, Instituto Superior Técnico,  Universidade de Lisboa, Portugal.}
...
\sigskip \signature{}{Francisco Maria Calisto\\Researcher\\francisco.calisto@tecnico.ulisboa.pt}
\end{minipage}
\hfill
}
%=============================
